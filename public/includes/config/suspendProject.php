    ...
    case isset($_POST['project_id']):
        switch (true) {
            default:
                ...
                $suspend = $project->suspendProject($_POST['project_id'], $_SESSION['name'], $_SESSION['designation'], $suspended_date);
                if($suspend == true)
                {
                    ...
                    echo 'success!=You have successfully suspended this project!';
                }else{
                    echo $suspend;
                }
            break;
